...
class Psr4AutoloaderClass
{
    ...
    public function addNamespace($prefix, $base_dir, $prepend = false)
    {
        ...
        //return "prefix, base_dir, prepend = " . $prefix . ' ' . $base_dir . ' ' . $prepend;
    ...
    public function loadClass($class)
    {
        ...
        while (false !== $pos = strrpos($prefix, '\\')) {
            ...
            //echo "<br />relative_class = " . $relative_class;

            // пробуем загрузить соответсвующий префиксу и относительному имени класса файл
            $mapped_file = $this->loadMappedFile($prefix, $relative_class);
            
            //echo "<br />mapped_file = " . $mapped_file;
            
            if ($mapped_file) {
                $this->mapped_file = $mapped_file;
                return $mapped_file;
            }
    ...
    protected function loadMappedFile($prefix, $relative_class)
    {
        ...
        //echo '<br />prefix - relative_class === ' . $prefix . ' - ' . $relative_class . '';
    ...
    public function loadClass2($class)
    {
        // текущий префикс пространства имён
        $prefix = $class;
        
        echo '$prefix = $class = ' . $class . e();

        // для определения имени файла обходим пространства имён из абсолютного
        // имени класса в обратном порядке
        while (false !== $pos = strrpos($prefix, '\\')) {
            echo 'prefix - class = ' . $prefix . ' <===> ' . $class . '<br />';
            ...
            return "RETURN - пробуем загрузить - mapped_file";
    ...
    public function getMappedFile() {
      return $this->mapped_file;
    }
